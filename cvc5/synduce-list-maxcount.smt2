...
(define-fun-rec
  ...
  (match x
    (((Elt tv5) (MakeTuple3 tv5 (Succ Zero)))
     ((Cons tv6 tv7)
      (MakeTuple3 (max (fst3 (tf1 tv7)) tv6)
        (ite2 (gq tv6 (fst3 (tf1 tv7)))
          (Succ Zero)
          (plus (snd3 (tf1 tv7))
     ...
     ((Concat tv28 tv29)
      (MakeTuple3
        (ite2 (nateq (snd3 (tf7 tv29)) (snd3 (tf7 tv28)))
          (plus (fst3 (tf7 tv29)) (fst3 (tf7 tv28)))
          (ite2 (lq (snd3 (tf7 tv29)) (snd3 (tf7 tv28)))
            (fst3 (tf7 tv28)) (fst3 (tf7 tv29))))
        (max (snd3 (tf7 tv29)) (snd3 (tf7 tv28))))))))
(define-fun
  mainNew
