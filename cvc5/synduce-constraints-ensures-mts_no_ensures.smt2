...
(define-fun-rec
  ...
  ((x List2)) Tuple3
  (match x
    (((Nil tv5) (MakeTuple3 Zero Zero))
     ((Cons tv6 tv7)
      (MakeTuple3 (max (fst3 (tf1 tv7)) (plus tv6 (snd3 (tf1 tv7))))
        (plus tv6 (snd3 (tf1 tv7))))))))
(define-fun
  spec
  ((x List2)) Nat (fst3 (tf1 x)))
(define-fun
  main
...
(define-fun-rec
  ...
  (match x
    (((Cnil tv28) (MakeTuple3 Zero Zero))
     ((Single tv29) (MakeTuple3 (max tv29 Zero) tv29))
     ((Concat tv30 tv31)
      (MakeTuple3
        (ite2
          (lq (plus (snd3 (tf7 tv31)) (fst3 (tf7 tv30))) (fst3 (tf7 tv31)))
          (fst3 (tf7 tv31)) (plus (snd3 (tf7 tv31)) (fst3 (tf7 tv30))))
        (plus (snd3 (tf7 tv31)) (snd3 (tf7 tv30))))))))
(define-fun
  mainNew
