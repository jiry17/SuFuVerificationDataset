  ...
  (match x
    (((Unil tv41) (Unil Null))
     ...
     ((Usplit tv43 tv44 tv45 tv46)
      (Usplit (tf11 tv43) tv44 tv45 (tf11 tv46))))))
(define-fun-rec
  tf1
  ...
  (match x
    (((Unil tv51) Zero)
     ...
     ((Usplit tv53 tv54 tv55 tv56)
      (ite3
        (and2 (lq (tf13 tv56) (max tv55 tv54))
          (lq (tf13 tv53) (max tv55 tv54)))
        (max tv55 tv54)
        (ite3 (lq (tf13 tv56) (tf13 tv53)) (tf13 tv53) (tf13 tv56)))))))
(define-fun-rec
  tf3
  ((x Nat) (y List2)) Bool2
  (match y
    (((Nil tv16) (geq x Zero))
     ((Cons tv17 tv18)
      (and2 (geq x Zero) (and2 (gq x tv17) (tf3 tv17 tv18)))))))
(define-fun-rec
  tf5
  ((x Nat) (y List2)) Bool2
  (match y
