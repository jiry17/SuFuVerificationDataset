  ...
  (assert (forall ((tv1 List) (tv0 List)) (= (concat tv0 tv1) (tf0 tv0 tv1))))
  (assert (forall ((tv12 Unit)) (= (tf3 (Nil tv12)) (Nil Null))))
  (assert (forall ((tv14 List) (tv13 Nat)) (= (tf3 (Cons tv13 tv14)) (concat (tf2 tv14) (Cons tv13 (Nil Null))))))
  ...
  (assert (forall ((tv29 List) (tv28 List)) (= (tf8 (Zip tv28 tv29)) (concat (rev tv28) (listrepr tv29)))))
