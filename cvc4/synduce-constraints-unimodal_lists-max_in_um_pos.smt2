  ...
  (assert (forall ((tv18 List) (tv17 Nat) (tv15 Nat)) (= (tf3 tv15 (Cons tv17 tv18)) (and (geq tv15 Zero) (and (gq tv15 tv17) (tf2 tv17 tv18))))))
  ...
  (assert (forall ((tv25 List) (tv24 Nat) (tv22 Nat)) (= (tf5 tv22 (Cons tv24 tv25)) (and (geq tv22 Zero) (ite2 (lq tv22 tv24) (tf4 tv24 tv25) (tf2 tv24 tv25))))))
  ...
  (assert (forall ((tv56 UList) (tv54 Nat) (tv55 Nat) (tv53 UList)) (= (tf13 (Usplit tv53 tv54 tv55 tv56)) (ite3 (and (lq (tf12 tv56) (max tv55 tv54)) (lq (tf12 tv53) (max tv55 tv54))) (max tv55 tv54) (ite3 (lq (tf12 tv56) (tf12 tv53)) (tf12 tv53) (tf12 tv56))))))
