  ...
  (assert (forall ((tv6 CList) (tv5 CList)) (= (tf1 (Concat tv5 tv6)) (and (tf0 tv5) (tf0 tv6)))))
  ...
  (assert (forall ((tv47 CList) (tv46 CList)) (= (tf11 (Concat tv46 tv47)) (MakeTuple3 (ite2 (and (lq (snd3 (tf10 tv47)) (snd3 (tf10 tv46))) (lq (fst3 (tf10 tv46)) (snd3 (tf10 tv47)))) (snd3 (tf10 tv47)) (ite2 (lq (snd3 (tf10 tv46)) (fst3 (tf10 tv47))) (fst3 (tf10 tv47)) (ite2 (lq (snd3 (tf10 tv47)) (snd3 (tf10 tv46))) (fst3 (tf10 tv46)) (snd3 (tf10 tv46))))) (max (snd3 (tf10 tv46)) (snd3 (tf10 tv47)))))))
