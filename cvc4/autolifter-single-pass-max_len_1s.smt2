  ...
  (assert (forall ((tv21 List) (tv20 MyBool) (tv18 Nat) (tv17 Nat)) (= (tf4 tv17 tv18 (Cons tv20 tv21)) (ite1 (not tv20) (tf3 (max tv18 tv17) Zero tv21) (tf3 tv18 (plus tv17 (Succ Zero)) tv21)))))
  ...
  (assert (forall ((tv29 List) (tv28 MyBool)) (= (tf6 (Cons tv28 tv29)) (MakeTuple2 (ite1 (or (not tv28) (lq (snd2 (tf5 tv29)) (fst2 (tf5 tv29)))) (fst2 (tf5 tv29)) (plus (Succ Zero) (fst2 (tf5 tv29)))) (ite1 (not tv28) Zero (plus (Succ Zero) (snd2 (tf5 tv29))))))))
