  ...
  (assert (forall ((tv15 BoolList) (tv14 MyBool)) (= (tf3 (Bcons tv14 tv15)) (and tv14 (tf2 tv15)))))
  ...
  (assert (forall ((tv23 List) (tv22 Nat)) (= (tf5 (Cons tv22 tv23)) (and (tf4 tv23) (lq tv22 (Succ Zero))))))
