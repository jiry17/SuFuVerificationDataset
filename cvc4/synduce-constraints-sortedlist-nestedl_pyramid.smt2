  ...
  (assert (forall ((tv23 NList) (tv22 List) (tv20 Nat)) (= (tf5 tv20 (Ncons tv22 tv23)) (and (leq tv20 (lmax tv22)) (tf4 (lmax tv22) tv23)))))
  ...
  (assert (forall ((tv39 NList) (tv38 List)) (= (tf11 (Ncons tv38 tv39)) (MakeTuple4 (min (fst3 (interval tv38)) (fst4 (tf10 tv39))) (max (snd3 (interval tv38)) (snd4 (tf10 tv39))) (and (third4 (tf10 tv39)) (and (leq (fst4 (tf10 tv39)) (fst3 (interval tv38))) (geq (snd4 (tf10 tv39)) (snd3 (interval tv38)))))))))
  ...
  (assert (forall ((tv53 NList) (tv52 List)) (= (tf15 (Ncons tv52 tv53)) (MakeTuple6 (and (fst6 (tf14 tv53)) (leq (snd6 (tf14 tv53)) (lmin tv52))) (snd6 (tf14 tv53))))))
