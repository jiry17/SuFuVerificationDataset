  ...
  (assert (forall ((tv5 Formula) (tv4 Formula)) (= (tf1 (Fand tv4 tv5)) (and (tf0 tv4) (tf0 tv5)))))
  (assert (forall ((tv7 Formula) (tv6 Formula)) (= (tf1 (Forr tv6 tv7)) (or (tf0 tv6) (tf0 tv7)))))
  ...
  (assert (forall ((tv23 MyBool)) (= (tf5 (Nfneglit tv23)) (not tv23))))
  (assert (forall ((tv25 NnfFormula) (tv24 NnfFormula)) (= (tf5 (Nfand tv24 tv25)) (and (tf4 tv25) (tf4 tv24)))))
  (assert (forall ((tv27 NnfFormula) (tv26 NnfFormula)) (= (tf5 (Nfor tv26 tv27)) (or (tf4 tv26) (tf4 tv27)))))
