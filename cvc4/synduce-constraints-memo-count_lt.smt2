  ...
  (assert (forall ((tv11 Nat) (tv10 Nat)) (= (tf2 (Mleaf tv10 tv11)) (and (geq tv10 Zero) (ite3 (lq tv11 (Succ (Succ Zero))) (nateq tv10 (Succ Zero)) (nateq tv10 Zero))))))
  (assert (forall ((tv15 TreeMemo) (tv13 Nat) (tv14 TreeMemo) (tv12 Nat)) (= (tf2 (Mnode tv12 tv13 tv14 tv15)) (and (and (geq tv12 Zero) (nateq tv12 (plus (ite4 (lq tv13 (Succ (Succ Zero))) (Succ Zero) Zero) (plus (memo tv14) (memo tv15))))) (and (tf1 tv14) (tf1 tv15))))))
