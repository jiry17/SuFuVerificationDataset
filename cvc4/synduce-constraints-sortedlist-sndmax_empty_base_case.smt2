  ...
  (assert (forall ((tv27 List) (tv26 Nat)) (= (tf6 (Cons tv26 tv27)) (and (geqhead tv26 tv27) (tf5 tv27)))))
  ...
  (assert (forall ((tv53 CList) (tv52 CList)) (= (tf12 (Concat tv52 tv53)) (MakeTuple3 (ite2 (and (lq (fst3 (tf11 tv52)) (snd3 (tf11 tv52))) (nateq (fst3 (tf11 tv52)) Zero)) (snd3 (tf11 tv53)) (ite2 (nateq (fst3 (tf11 tv52)) Zero) (plus (fst3 (tf11 tv52)) (fst3 (tf11 tv53))) (fst3 (tf11 tv52)))) (max (snd3 (tf11 tv52)) (snd3 (tf11 tv53)))))))
