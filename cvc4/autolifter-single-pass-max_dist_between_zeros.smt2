  ...
  (assert (forall ((tv19 List) (tv18 MyBool) (tv16 Nat)) (= (tf4 tv16 (Cons tv18 tv19)) (max (ite1 (not tv18) Zero (plus tv16 (Succ Zero))) (tf3 (ite1 (not tv18) Zero (plus tv16 (Succ Zero))) tv19)))))
  ...
  (assert (forall ((tv27 List) (tv26 MyBool)) (= (tf6 (Cons tv26 tv27)) (MakeTuple2 (ite1 (or (not tv26) (lq (snd2 (tf5 tv27)) (fst2 (tf5 tv27)))) (fst2 (tf5 tv27)) (plus (Succ Zero) (fst2 (tf5 tv27)))) (ite1 (not tv26) Zero (plus (Succ Zero) (snd2 (tf5 tv27))))))))
