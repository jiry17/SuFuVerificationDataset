  ...
  (assert (forall ((tv17 List) (tv16 MyBool) (tv14 MyBool)) (= (tf4 tv14 (Cons tv16 tv17)) (ite1 (and tv14 (not tv16)) (tf3 (or tv14 tv16) tv17)))))
  ...
  (assert (forall ((tv25 List) (tv24 MyBool)) (= (tf6 (Cons tv24 tv25)) (MakeTuple2 (or (and tv24 (not (snd2 (tf5 tv25)))) (fst2 (tf5 tv25))) (and tv24 (snd2 (tf5 tv25)))))))
