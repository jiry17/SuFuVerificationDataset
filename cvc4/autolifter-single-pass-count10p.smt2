  ...
  (assert (forall ((tv16 MyBool) (tv19 List) (tv18 MyBool) (tv15 MyBool)) (= (tf4 tv15 tv16 (Cons tv18 tv19)) (plus (ite1 (and tv16 tv18) (Succ Zero) Zero) (tf3 tv18 (and (not tv18) (or tv15 tv16)) tv19)))))
  ...
  (assert (forall ((tv31 List) (tv30 MyBool)) (= (tf7 (Cons tv30 tv31)) (MakeTuple2 (ite1 (or (or (not tv30) (nateq (fst2 (tf6 tv31)) (snd2 (tf6 tv31)))) (alhead tv31)) (fst2 (tf6 tv31)) (plus (Succ Zero) (fst2 (tf6 tv31)))) (ite1 (not tv30) (snd2 (tf6 tv31)) (plus (Succ Zero) (snd2 (tf6 tv31))))))))
