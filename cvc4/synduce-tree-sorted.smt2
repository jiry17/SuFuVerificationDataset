  ...
  (assert (forall ((tv6 Tree) (tv5 Tree) (tv4 Nat)) (= (tf1 (Node tv4 tv5 tv6)) (MakeTuple1 tv4 (and (and (and (lq (fst1 (tf0 tv5)) tv4) (lq tv4 (fst1 (tf0 tv6)))) (snd1 (tf0 tv5))) (snd1 (tf0 tv6)))))))
  ...
  (assert (forall ((tv21 Tree) (tv20 Tree) (tv19 Nat)) (= (tf5 (Node tv19 tv20 tv21)) (MakeTuple2 (and (and (and (lq (snd2 (tf4 tv20)) tv19) (fst2 (tf4 tv21))) (fst2 (tf4 tv20))) (lq tv19 (snd2 (tf4 tv21)))) tv19))))
