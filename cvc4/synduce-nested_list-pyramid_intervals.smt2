  ...
  (assert (forall ((tv15 NList) (tv14 List)) (= (tf3 (Ncons tv14 tv15)) (MakeTuple4 (min (fst4 (tf2 tv15)) (fst3 (interval tv14))) (max (snd4 (tf2 tv15)) (snd3 (interval tv14))) (and (third4 (tf2 tv15)) (and (leq (fst4 (tf2 tv15)) (fst3 (interval tv14))) (leq (snd4 (tf2 tv15)) (snd3 (interval tv14)))))))))
  ...
  (assert (forall ((tv29 NList) (tv28 List)) (= (tf7 (Ncons tv28 tv29)) (MakeTuple5 (and (and (leq (snd5 (tf6 tv29)) (fst3 (interval tv28))) (fst5 (tf6 tv29))) (leq (third5 (tf6 tv29)) (snd3 (interval tv28)))) (snd5 (tf6 tv29)) (snd3 (interval tv28))))))
