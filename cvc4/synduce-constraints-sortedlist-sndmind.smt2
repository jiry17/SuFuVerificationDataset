  ...
  (assert (forall ((tv33 Nat) (tv34 Nat) (tv32 Nat)) (= (tf7 tv32 (Two tv33 tv34)) (and (gq tv32 tv33) (gq tv33 tv34)))))
  (assert (forall ((tv35 Nat) (tv36 List) (tv32 Nat)) (= (tf7 tv32 (Cons tv35 tv36)) (and (gq tv32 tv35) (tf6 tv35 tv36)))))
