  ...
  (assert (forall ((tv43 CList) (tv42 Nat) (tv41 CList)) (= (tf11 (Cat tv41 tv42 tv43)) (and (and (lq (tf8 tv41) tv42) (lq tv42 (tf6 tv43))) (and (tf10 tv41) (tf10 tv43))))))
  ...
  (assert (forall ((tv49 NList) (tv48 List)) (= (tf13 (Ncons tv48 tv49)) (MakeTuple4 (ite3 (and (snd4 (tf12 tv49)) (geq (lsum tv48) Zero)) (plus (fst4 (tf12 tv49)) (lsum tv48)) (fst4 (tf12 tv49))) (and (snd4 (tf12 tv49)) (geq (lsum tv48) Zero))))))
