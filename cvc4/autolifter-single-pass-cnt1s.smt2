  ...
  (assert (forall ((tv16 Nat) (tv19 List) (tv18 MyBool) (tv15 MyBool)) (= (tf4 tv15 tv16 (Cons tv18 tv19)) (tf3 tv18 (ite1 (and (not tv15) tv18) (plus tv16 (Succ Zero)) tv16) tv19))))
  ...
  (assert (forall ((tv27 List) (tv26 MyBool)) (= (tf6 (Cons tv26 tv27)) (MakeTuple2 (ite1 (or (not tv26) (snd2 (tf5 tv27))) (fst2 (tf5 tv27)) (plus (Succ Zero) (fst2 (tf5 tv27)))) tv26))))
